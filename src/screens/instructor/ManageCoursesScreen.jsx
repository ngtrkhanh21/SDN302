...
export default function ManageCoursesScreen({ navigation }) {
      ...
      <View style={styles.card}>
        ...
        {hasImage ? (
          ...
          <View style={styles.imagePlaceholder}>
            ...
            <Text style={styles.imagePlaceholderText}>Chưa có ảnh bìa</Text>
          </View>
        )}
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.courseMeta} numberOfLines={2}>
            {item.content || item.description || "Chưa có mô tả."}
          </Text>
          ...
          <View style={styles.actionsRow}>
            ...
            >
              <Text style={styles.btnText}>📚 Nội dung</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.btn, styles.editBtn]}
              onPress={() =>
                navigation.navigate("Upload", { courseToEdit: item })
              }
            >
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Sắp xếp và cập nhật bài giảng của bạn</Text>
