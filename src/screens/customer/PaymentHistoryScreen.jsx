...
export default function PaymentHistoryScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      {isLoading ? (
        <ActivityIndicator style={{ marginTop: 24 }} color="#e17055" size="large" />
      ) : payments.length === 0 ? (
        ...
        payments.map(item => {
          ...
          return (
            <View key={String(pid)} style={styles.card}>
              ...
              <Text style={styles.amount}>{Number(amount).toLocaleString('vi-VN')} VND</Text>
              <View style={styles.cardRow}>
...
const styles = StyleSheet.create({
  ...
  amount: { fontSize: 18, fontWeight: '800', color: '#e17055', marginVertical: 6 },
